		...
		<div class="page-content">
			<div class="row d-flex justify-content-center">
				<div class="col-md-7">
					...
					<form method="post" action="<?php url('admin/' . ($mode == "add" ? "input" : "edit/" . $post['user_id'])) ?>">
						<div class="card">
							<div class="card-header">
								<?php if ($mode == 'edit'): ?>
									<div class="float-right">
										<a href="<?php url('admin/input') ?>" class="btn btn-secondary btn-sm">
								...
								<?php endif ?>
								<h4 class="mt-1 mb-0">
									<a href="<?php url("admin") ?>" class="text-muted"><i class="fa fa-fw fa-arrow-left"></i></a>
									<?php echo ($mode == "add" ? "Input" : "Edit"); ?> Perpustakawan
								</h4>
							</div>
							<?php if (isset($errors)): ?>
							...
							<div class="card-footer text-secondary pb-0 pt-3">
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<button type="submit" class="btn btn-primary"><?php echo ($mode == "add" ? "Input" : "Edit"); ?> Perpustakawan</button>
									</div>
								</div>
							</div>
						</div>
